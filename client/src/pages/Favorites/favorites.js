...
const renderRecipes = () => {
  if(recipeData[0]) {
    ...
    return (
      <>
        <h5>
         You have no favorited recipes. Open a recipe and click <MdFavoriteBorder/> to add it to your favorites list
        </h5>
      </>
    )
  }
  ...
  return (
    ...
    <div>
        ...
        <h3 className="favRecipeHeader">Your Favorite Recipes</h3>
